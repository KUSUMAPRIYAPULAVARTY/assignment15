...
\begin{align}
    ...
    =\myvec{\vec{A}&\vec{B}} \left[\vec{I}\otimes \myvec{x\\0}+\vec{I}\otimes \myvec{0\\y}\right]\\
   =\myvec{\vec{A}&\vec{B}}  \vec{I}\otimes \myvec{x\\0}+\myvec{\vec{A}&\vec{B}}  \vec{I}\otimes \myvec{0\\y}\\
   =x\myvec{\vec{A}&\vec{B}}  \vec{I}\otimes \myvec{1\\0}+y\myvec{\vec{A}&\vec{B}}  \vec{I}\otimes \myvec{0\\1}\\
   \vec{x}=x\myvec{1\\0}+y\myvec{0\\1}\\
   \mathbbf{T}(\vec{x})=x\myvec{\vec{A}&\vec{B}}\vec{I}\otimes \myvec{1\\0}+y\myvec{\vec{A}&\vec{B}}  \vec{I}\otimes \myvec{0\\1}
\end{align}
\end{document}
